  ...
  if (!user || !user.isProvider) {
    return (
      <Container className="py-5 text-center">
        <Alert variant="warning">Debes ser un proveedor para acceder al dashboard</Alert>
          ...
          <Card className="mb-4">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <Badge bg={profile.isAvailable ? "success" : "danger"} className="availability-badge">
        ...
        <Col lg={4}>
          <Card className="mb-4">
            <Card.Body>
              ...
              <div className="d-grid gap-2">
                <Link to={`/provider/${user.id}`} className="btn btn-outline-primary">
          ...
          <Card>
            <Card.Body>
              ...
              <div className="d-grid gap-2">
                <Button variant={profile.isAvailable ? "outline-danger" : "outline-success"}>
                  {profile.isAvailable ? "Marcar como No Disponible" : "Marcar como Disponible"}
                </Button>
